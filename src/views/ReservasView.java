...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(ReservasView.class.getResource("/imagenes/aH-40px.png")));//Adiciona el Ã­cono a nuestro programa
		...
		// CÃ³digo que crea los elementos de la interfÃ¡z grÃ¡fica
	...
	private void guardarReserva() {	
		...
		JOptionPane.showMessageDialog(null,"Registro Guardado con exito " + nuevaReserva.getId());
