...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
	    ...
	    String textoDescripcion = "<html><body>Sistema de reserva de hotel. "
	    		+ "Controle y administre de forma Óptima y fácil <br> el flujo de reservas "
	    		+ "y de huespedes del hotel   </body></html>";
	    ...
	    String textoDescripcion1 = 
	    		"<html><body> Esta herramienta le permitira¡ "
	    		+ "llevar un control completo y detallado de sus reservas y huespedes, "
	    		+ "tendrá¡ acceso a heramientas especiales para tareas específicas como lo son:"
	    		+ "</body></html>";
